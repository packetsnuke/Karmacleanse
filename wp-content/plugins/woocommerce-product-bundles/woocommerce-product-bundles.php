...
if ( is_woocommerce_active() ) {
	...
	class WC_Product_Bundles {
		...
		function woo_bundles_admin_scripts() {
			...
			wp_register_script( 'woo_bundles_writepanel', $this->woo_bundles_plugin_url() . '/assets/js/bundled-product-write-panels.js', array('jquery', 'jquery-ui-datepicker', 'woocommerce_writepanel'), '3.0.2' );

			wp_register_style( 'woo_bundles_css', $this->woo_bundles_plugin_url() . '/assets/css/bundles-write-panels.css', array('woocommerce_admin_styles'), '3.0.2' );
		...
		function woo_bundles_frontend_scripts() {
			wp_register_script( 'wc-add-to-cart-bundle', $this->woo_bundles_plugin_url() . '/assets/js/add-to-cart-bundle.js', array('jquery'), '3.0.2', true );
			wp_register_style( 'wc-bundle-css', $this->woo_bundles_plugin_url() . '/assets/css/bundles-frontend.css', false, '3.0.2' );
