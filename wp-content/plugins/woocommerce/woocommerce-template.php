...
if ( ! function_exists( 'woocommerce_output_product_data_description' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_output_product_data_description() {
...
if ( ! function_exists( 'woocommerce_deposit_display' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_deposit_display() {
		woocommerce_get_template( 'cart/deposit.php' );
	}
}
