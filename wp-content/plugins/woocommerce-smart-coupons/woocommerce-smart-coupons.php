    ...
    load_plugin_textdomain('wc_smart_coupons', false, dirname( plugin_basename( __FILE__ ) ) . '/languages');
        ...
        class WC_Smart_Coupons {
                        ...
                        function call_for_credit_form() {
                            ...
                            if ( !empty( $coupons ) && $this->is_coupon_amount_pick_from_product_price( $coupons ) && ( !( $product->get_price() != '' || ( is_plugin_active( 'woocommerce-name-your-price/woocommerce-name-your-price.php' ) && ( get_post_meta( $product->id, '_nyp', true ) == 'yes' ) ) ) ) ) {
                                ...
                                <div id="call_for_credit">
                                    ...
                                    <p style="float: left">
                                    <?php 
                                        echo __('Purchase Credit worth ', 'wc_smart_coupons') . '(' . $currency_symbol . ')'; 
                                        echo '</p><br /><br />';
                                        echo "<input id='credit_called' type='text' name='credit_called' value='' autocomplete='off' />";
                                    ?>
                                ...
                                jQuery.ajax({
                                    ...
                                    success: function( response ) {
                                        jQuery('body').html( response );
                                                                            ...
                                                                            if( jQuery('div#coupons_list').find('li').length == 0 ) {
                                                                                jQuery('div#coupons_list h3').css('display' , 'none');
                                                                            }
                                    }
                                });
                                return false;
            ...
            function show_smart_coupon_balance() {
                ...
                if ( $coupons ) {
                    ?>
                    <h2><?php _e('Available Store Credit / Coupons', 'wc_smart_coupons'); ?></h2>
                    <ul class="gift-certificate">
                        ...
                        foreach ( $coupons as $code ) {
                            ...
                            echo '<li><strong>' . $coupon->code . ' (' . $coupon_type  . ')</strong> &mdash;'. $coupon_amount .'</li>';
...
//                                                   jQuery('form#generate_coupons').append(' <?php // wp_nonce_field( 'import-woocommerce-coupon' ); ?> ');
//                                                   jQuery('span#desc_for_file').text("File to be imported will be stored at <?php echo $upload_path  ?>") ;
                    ...
                    <h3 class="title"><?php _e('Generate Coupons', 'wc_csv_import'); ?></h3>
                                ...
                                <td>
                                    <input type="text" name="sc_suffix_for_code" id="sc_suffix" class="input-text" />
                                                        ...
                                                        <tr>
                                                            <th></th>
                                                            <td>
                                                                <label for="sc_export_and_import"><input type="checkbox" name="sc_export_and_import" id="sc_export_and_import"  /> 
                                                                    <?php _e( 'Generate only, do not add these coupons in WooCommerce. </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This will download a .CSV file which you can later import from ', 'wc_smart_coupons' ); 
                                                                            echo '<a href="admin.php?page=woocommerce_coupon_csv_import&tab=import">' . __( 'Import Coupons', 'wc_smart_coupons' ) . '</a>'; ?></label>
                                                            </td>
                                                        </tr>
                                ...
                                ?>                                   
                                    <style type="text/css">
                                            ...
                                            input#export_coupons{
                                                ...
                                                background-image:url("<?php echo plugins_url( 'images/import.png' , __FILE__ ) ; ?>");
