...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="form-row place-order">
            ...
            <?php _e( '<center><p>For Information on the Pickup Location, <a target="blank" href="http://mykarmacleanse.com/?page_id=149">Click Here</a><br> By clicking Place Order, you acknowledge that you have read and accept the <a href-"http://mykarmacleanse.com/?page_id=54" target="blank">Terms and Conditions</a></p></center>'); ?>
  
            <?php if (woocommerce_get_page_id('terms')>0) : ?>
			<p class="form-row terms">
				<label for="terms" class="checkbox"><?php _e( 'For Information on the Pickup Location, <a target="blank" href="http://mykarmacleanse.com/?page_id=149">Click Here</a><br> I have read and accept the', 'woocommerce' ); ?> <a href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'terms &amp; conditions', 'woocommerce' ); ?></a></label>
